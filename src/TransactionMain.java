...
public class TransactionMain
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					TransactionMain window = new TransactionMain();
	...
	private void initialize()
	{
		...
		JRadioButton btnBari = new JRadioButton("Bari");
		btnBari.setBounds(51, 158, 144, 23);
		panel.add(btnBari);
		
		JRadioButton btnUzair = new JRadioButton("Uzair");
		btnUzair.setBounds(51, 198, 144, 23);
		panel.add(btnUzair);
		
		JRadioButton btnShahbaz = new JRadioButton("Shahbaz");
		btnShahbaz.setBounds(51, 238, 144, 23);
		panel.add(btnShahbaz);
		
		JRadioButton btnMusab = new JRadioButton("Musab");
